  ...
  return (
    ...
    >
      ...
      <div className="relative mb-[100px] text-center md:mb-0">
        ...
        <h2 className="relative -top-[100px] mb-4 text-center text-5xl font-bold text-blue-500 dark:text-purple-300/90 md:-top-[180px]">
          Dremák Olivér
        </h2>

        <h3 className="relative -top-[100px] text-center text-4xl text-gray-800 dark:text-gray-200 md:-top-[180px]">

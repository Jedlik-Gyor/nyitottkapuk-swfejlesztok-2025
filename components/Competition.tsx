  ...
  return (
    <div className="container mx-auto px-4 py-20 text-gray-900 dark:text-white" id="competitions">
      ...
      <div className="relative mb-[100px] text-center md:mb-0">
        ...
        <h2 className="relative -top-[100px] mb-4 text-center text-5xl font-bold text-blue-500 md:-top-[180px] dark:text-purple-300/90">
          Dremák Olivér
        </h2>

        <h3 className="relative -top-2.5 text-center text-4xl text-gray-800 md:-top-[50px] dark:text-gray-200">
